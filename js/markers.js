var locations = [
     //Hotels
    ['<h2>Royalton Resort & Spa</h2><p>Hotel</p><p>Treat yourself to this luxuarious all-inclusive resort destination which over looks the carribean sea. This resort is split into 3 sections: the resort, the Diamond Club and the (adults only) Hideaway.<li>Suitable for couples and families.</li></p>', 14.0969 , -60.9498],
    ['<h2>St James Club Morgan Bay</h2><p>Hotel</p><p>This relaxing location for everyone. This is an all inclusive which includes meals and beaerages.<li>Suitable for families and couples.</p>', 14.0406, -60.9706],
